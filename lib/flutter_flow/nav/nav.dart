...
class AppStateNotifier extends ChangeNotifier {
  CacaoShowFirebaseUser? initialUser;
  CacaoShowFirebaseUser? user;
  ...
  void update(CacaoShowFirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, _) =>
          appStateNotifier.loggedIn ? HomePageWidget() : SamplePageWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
          ...
          routes: [
            FFRoute(
              name: 'LoginSimple',
              path: 'loginSimple',
              builder: (context, params) => LoginSimpleWidget(),
            ),
            FFRoute(
              name: 'locationList',
              path: 'locationList',
            ...
            FFRoute(
              name: 'locationDetail',
              path: 'locationDetail',
              builder: (context, params) => LocationDetailWidget(
                image: params.getParam('image', ParamType.String),
              ),
            ),
            FFRoute(
              name: 'locationListCopy',
              path: 'locationListCopy',
              builder: (context, params) => LocationListCopyWidget(),
            ),
            FFRoute(
              name: 'CreatePosts',
              path: 'createPosts',
              builder: (context, params) => CreatePostsWidget(),
            ),
            FFRoute(
              name: 'SamplePage',
              path: 'samplePage',
